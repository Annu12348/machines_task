...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-200 flex items-center justify-center p-4 sm:p-5">
      <div className="w-full  bg-white rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-5 shadow-lg min-h-[550px]">
        <div className="p-6 flex flex-col justify-center col-span-1 md:col-span-2">
          ...
          <form className="space-y-2" onSubmit={handleSubmit} noValidate autoComplete="off">
            <div>
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-200 flex items-center justify-center p-4  sm:p-4">
      <div className="w-full  bg-white rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-5 shadow-lg min-h-[550px]">
        <div className="p-6 flex flex-col justify-center col-span-1 md:col-span-2">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-800 mb-3">Admin Registration</h1>
          <p className="text-slate-500 mb-8 text-base">
